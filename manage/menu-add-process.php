...
if (isset($_GET['course_id'])) {
    ...
    if (strlen($menu_name) <= 2) {
        echo "<script>alert('โปรดกรอกชื่อเมนูอย่างน้อย 3 ตัวอักษร');</script>";
    } else if (strlen($menu_detail) <= 6) {
        echo "<script>alert('โปรดกรอกชื่อเมนูอย่างน้อย 7 ตัวอักษร');</script>";
    } else if (strlen($menu_img) <= 8) {
        echo "<script>alert('โปรดกรอกชื่อเมนูอย่างน้อย 9 ตัวอักษร');</script>";
    } else {
